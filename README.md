...
I would write Terraform code to define all the resources I want to provision. This would typically be a multi-account setup where each environment (qa, stg and prod) is deployed in its own separate AWS account to reduce its blast radius
